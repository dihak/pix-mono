...
Set `collapse.tools.edit: false` to disable for this tool only. See `@dihak/pix-data/collapse` for the full API.

## Install

```bash
pi install npm:@dihak/pix-edit
```
